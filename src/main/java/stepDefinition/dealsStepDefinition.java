 ...
 * enter_login_credentials(DataTable credentials) { List<List<String>> data =
 * credentials.raw();
 * 
 ...
 * Thread.sleep(5000); }
 * 
 * @Then("^user enters details title and Probability and Commission$") public
 * void enter_new_deals_details(DataTable data) throws InterruptedException {
